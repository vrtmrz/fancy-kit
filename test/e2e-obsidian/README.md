...
The catalogue currently covers text and password prompts, typed selection, Markdown dialogs, and progress Notice lifecycle behaviour.
...
4. enables the showcase and invokes story commands through `obsidian-cli`;
